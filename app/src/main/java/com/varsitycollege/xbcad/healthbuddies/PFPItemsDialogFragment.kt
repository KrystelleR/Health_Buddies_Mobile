...
class PFPItemsDialogFragment(private val uid: String, private val callback: MainActivity) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            databaseReference = FirebaseDatabase.getInstance().reference.child("PurchasedItems").child(uid).child("characters")
